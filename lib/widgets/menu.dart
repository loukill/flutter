...
import 'package:flutter_dashboard/widgets/bibliotheque/article_form.dart';
...
class _MenuState extends State<Menu> {
  ...
  if (menu[i].title == "Activity") {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CategoryDashboard()), // Remplacez ProductPage() par la page de produit
    );
