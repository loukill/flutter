...
class _MenuState extends State<Menu> {
  List<MenuModel> menu = [
    ...
    MenuModel(icon: 'assets/svg/exercise.svg', title: "Activities"),
    MenuModel(icon: 'assets/svg/Biblio.svg', title:"Bibliotheque"), 
    MenuModel(icon: 'assets/svg/setting.svg', title: "forum"),
    MenuModel(icon: 'assets/svg/history.svg', title: "Produit"),
  ...
  context,
  MaterialPageRoute(
    builder: (context) => ArticalManagementScreen(articals: []),
  ),
);
                  },
                  child: Row(
